...
export function Header({ onShowSplash, showingDashboard }: HeaderProps = {}) {
  ...
  return (
    <header className="border-b border-[#E8F0FB] bg-white">
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className={cn(
                      "gap-1 text-sm font-medium hover:bg-[#E8F0FB] relative",
          ...
          <div className="flex items-center gap-4">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="gap-2 text-[#3B4760] hover:bg-[#E8F0FB]">
            ...
            <Button variant="ghost" size="icon" className="relative text-[#6A738A] hover:bg-[#E8F0FB]">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="rounded-full text-[#6A738A] hover:bg-[#E8F0FB]">
